...
For more details, see the Barkla user manual.

## Logging In
For a video of how to log in to Barkla using MobaXterm, which is generally the same procedure for any HPC [see this video](https://stream.liv.ac.uk/cpdedcxw).

## Directories and Default Environment
### Disk space and its divisions
###  Uploading data
